---
title: "Hosting"
source_url: "https://docs.odoo.sbggai.top/administration/hosting.html"
---
...
#. [Submit a support ticket ](https://www.odoo.com/help) including the following:
...
> **note**:
>    If you have time constraints, [submit a support ticket ](https://www.odoo.com/help) as soon as
...
>       If there is an active Odoo subscription linked to the database being migrated, reach out to
      the Customer Service Manager or [submit a support ticket ](https://www.odoo.com/help)  to
      complete the subscription transfer.

## To on-premise

#. Sign in to [the Odoo Online database manager ](https://www.odoo.com/my/databases/) and click the
...
#. [Create a support ticket ](https://www.odoo.com/help) including the following:
