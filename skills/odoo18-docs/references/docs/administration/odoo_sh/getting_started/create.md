---
title: ""
source_url: "https://docs.odoo.sbggai.top/administration/odoo_sh/getting_started/create.html"
---
...
Go to [Odoo.sh ](https://www.odoo.sh/) and hit the *Deploy your platform* button.
...
* to commit changes to make your deployment easier, merging branches or adding new [submodules
  ](https://git-scm.com/book/en/v2/Git-Tools-Submodules) for example.
...
[Access your databases manager ](https://accounts.odoo.com/my/databases/manage) and download a
