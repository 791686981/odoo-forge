---
title: "Settings"
source_url: "https://docs.odoo.sbggai.top/administration/odoo_sh/getting_started/settings.html"
---
...
repository. Refer to [GitHub's documentation on personal access tokens ](https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/managing-your-personal-access-tokens)
...
>    In case you want to analyze disk usage, you can run the tool [ncdu
   ](https://dev.yorhel.nl/ncdu/man) in your Web Shell.
