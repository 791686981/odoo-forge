...
source_url: "https://docs.odoo.sbggai.top/applications/essentials/in_app_purchase.html"
---
...
](https://iap.odoo.com/iap/all-in-app-services), and pricing is specific to each service.

.. example::
   The [SMS service ](https://iap.odoo.com/iap/in-app-services/1) has four packs available, in
   denominations of:
