---
title: "Domain names"
source_url: "https://docs.odoo.sbggai.top/applications/websites/website/configuration/domain_names.html"
---
...
.. seealso::
   ...
   ](https://www.odoo.com/slides/slide/register-a-free-domain-name-1663)
...
](https://www.odoo.com/my/databases), click the gear icon (:guilabel:`⚙️`) next to the database
...
To do so, open the [database manager ](https://www.odoo.com/my/databases), click the gear icon
...
manager ](https://www.odoo.com/my/databases), click the gear icon (:guilabel:`⚙️`) next to the
...
#. [Sign up and log in to Cloudflare ](https://dash.cloudflare.com/sign-up).
#. Enter your domain name on [Cloudflare's dashboard ](https://dash.cloudflare.com/login) and
...
>    Ensure you have :ref:`added a CNAME record <domain-name/cname>` to your domain name's DNS
   **before** mapping your domain name to your Odoo database.
   ...
   ](https://www.odoo.com/help), including screenshots of your CNAME records.
...
>    Mapping your domain name to your Odoo website prevents Google Search from indexing your original
   ...
   ](https://search.google.com/search-console/welcome) to fix the issue.
