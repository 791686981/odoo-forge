...
source_url: "https://docs.odoo.sbggai.top/applications/websites/website/configuration/spam_protection.html"
---
...
>    Analytics and additional settings are available on [Google's reCAPTCHA administration page
   ](https://www.google.com/recaptcha/admin/). For example, you can receive email alerts if Google
