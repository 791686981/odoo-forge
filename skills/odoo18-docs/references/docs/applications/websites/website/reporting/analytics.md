...
source_url: "https://docs.odoo.sbggai.top/applications/websites/website/reporting/analytics.html"
---
...
#. Once done, click the Plausible.io logo in the upper-left part of the page to access your [list of
   websites ](https://plausible.io/sites), then click the :icon:`fa-ellipsis-v` (:guilabel:`ellipsis`) icon next to the
...
#. Complete the next steps: [property creation ](https://support.google.com/analytics/answer/9304153?hl=en/&visit_id=638278591144564289-3612494643&rd=2#property),
...
.. seealso::
   ...
   ](https://support.google.com/tagmanager/answer/7679320?hl=en&ref_topic=7679108&sjid=17684856364781654579-EU)
