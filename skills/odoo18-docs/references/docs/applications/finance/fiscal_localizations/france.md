---
title: "France"
source_url: "https://docs.odoo.sbggai.top/applications/finance/fiscal_localizations/france.html"
---
...
[Teledec ](https://www.teledec.fr) is a platform used to prepare and submit tax returns using data
...
To create a Teledec account, access the [Teledec account creation page ](https://www.teledec.fr/s-enregistrer)
...
- Download the mandatory certificate of conformity delivered by Odoo SA [here ](https://www.odoo.com/my/contract/french-certification/)_.
