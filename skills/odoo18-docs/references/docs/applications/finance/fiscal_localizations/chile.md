---
title: "Chile"
source_url: "https://docs.odoo.sbggai.top/applications/finance/fiscal_localizations/chile.html"
---
...
>    Watch the two webinar recordings below for a general presentation of the localization, and search
   ...
   - [Playlist of tutorials
     ](https://youtube.com/playlist?list=PL1-aSABtP6AB6UY7VUFnVgeYOaz33fb4P).

.. seealso::
   - [Chilean localization app tour ](https://www.youtube.com/watch?v=3qYkgbmBYHw)
   - [Chilean localization smart tutorial
     ](https://www.odoo.com/slides/smart-tutorial-localizacion-de-chile-131)
...
>    If you are hosted in Odoo SH or On-Premise, you should manually install the [pdf417gen
   ](https://pypi.org/project/pdf417gen/) library. Use the following command to install it:
...
- | **Error:** `Usuario sin permiso de envio.`
  | **Hint:** this error indicates that most likely, your company has not passed the [Certification
    process ](https://www.sii.cl/factura_electronica/factura_mercado/proceso_certificacion.htm) in
