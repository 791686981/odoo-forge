---
title: "Jordan"
source_url: "https://docs.odoo.sbggai.top/applications/finance/fiscal_localizations/jordan.html"
---
...
[Government manuals ](manuals_) provide instructions for creating an account and generating the API
credentials.
...
#. If you don't already have an account, create one by going to the [government manuals ](manuals_)
...
#. Generate API credentials (Activity Number, Secret Key, and Client ID) by going to the [government
   manuals ](manuals_) page and following the steps in **Procedure Manual for Linking to the
...
#. Install the `Sanad app <https://www.sanad.gov.jo/Default/en).
