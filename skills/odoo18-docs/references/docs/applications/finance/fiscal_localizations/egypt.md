---
title: "Egypt"
source_url: "https://docs.odoo.sbggai.top/applications/finance/fiscal_localizations/egypt.html"
---
...
](https://sdk.preprod.invoicing.eta.gov.eg/codes/) to code your business attributes.
...
>    You can contact the :abbr:`ETA (Egyptian Tax Authority)` or [Egypt Trust
   ](https://www.egypttrust.com/) to get these USB keys.
