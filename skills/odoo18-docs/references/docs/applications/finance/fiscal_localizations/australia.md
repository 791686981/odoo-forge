---
title: "Australia"
source_url: "https://docs.odoo.sbggai.top/applications/finance/fiscal_localizations/australia.html"
---
...
Odoo allows companies under the [Deferred Goods and Services Tax (DGST) scheme ](https://www.ato.gov.au/businesses-and-organisations/gst-excise-and-indirect-taxes/gst/in-detail/rules-for-specific-transactions/international-transactions/deferred-gst?=redirected_deferredGSTscheme)
...
refer to the [ATO's TPAR web page ](https://www.ato.gov.au/businesses-and-organisations/preparing-lodging-and-paying/reports-and-returns/taxable-payments-annual-report).
...
](https://peppol.org/learn-more/country-profiles/australia/). Set up your customers and vendors
...
](https://www.ausbanking.org.au/). It is designed for business customers to facilitate bulk payment
...
solutions are available via [Stripe ](https://stripe.com/en-au/payments/payment-methods) and
