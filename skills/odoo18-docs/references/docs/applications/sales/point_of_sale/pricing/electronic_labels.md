...
source_url: "https://docs.odoo.sbggai.top/applications/sales/point_of_sale/pricing/electronic_labels.html"
---
...
#. [Get in touch with Pricer ](https://www.pricer.com/contact) to create and configure your Pricer
   account.
