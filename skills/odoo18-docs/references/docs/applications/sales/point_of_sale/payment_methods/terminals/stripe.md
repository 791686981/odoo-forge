---
title: "Stripe"
source_url: "https://docs.odoo.sbggai.top/applications/sales/point_of_sale/payment_methods/terminals/stripe.html"
---
...
>    - When you use **Stripe** exclusively in Point of Sale, you only need the **Secret Key** to use
   ...
   - For databases hosted **On-Premise**, the :guilabel:`Connect Stripe` button does not work. To
     ...
     ](https://dashboard.stripe.com), type `API` in the search bar, and click
...
#. Log into your [Stripe's dashboard ](https://dashboard.stripe.com) and go to
