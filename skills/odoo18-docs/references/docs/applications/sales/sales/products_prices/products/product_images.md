...
source_url: "https://docs.odoo.sbggai.top/applications/sales/sales/products_prices/products/product_images.html"
---
...
#. Go to the [Google Cloud Platform API & Services ](https://console.developers.google.com/) page
...
#. Next, go to [Google Programmable Search Engine ](https://programmablesearchengine.google.com/),
