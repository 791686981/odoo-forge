...
source_url: "https://docs.odoo.sbggai.top/applications/sales/sales/shopee_connector/setup.html"
---
...
](https://open.shopee.com/), and click the :guilabel:`Get Access (Now)` button located in the
middle of the page.
...
>    You'll need your Open Shopee :guilabel:`Partner ID` and :guilabel:`Partner Key` to complete this
   ...
   #. **Log in to the Shopee Open Platform:** [Log in ](https://open.shopee.com/) with the
