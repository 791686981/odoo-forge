---
title: "Common emailing issues and solutions"
source_url: "https://docs.odoo.sbggai.top/applications/general/email_communication/faq.html"
---
...
](https://en.wikipedia.org/wiki/Simple_Mail_Transfer_Protocol) is a standard used to transmit
...
](https://en.wikipedia.org/wiki/List_of_SMTP_server_return_codes#Common_status_codes). While the
