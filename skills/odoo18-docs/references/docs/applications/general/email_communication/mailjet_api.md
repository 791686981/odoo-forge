---
title: "Mailjet API"
source_url: "https://docs.odoo.sbggai.top/applications/general/email_communication/mailjet_api.html"
---
...
[Mailjet Account Information ](https://app.mailjet.com/account) page. Next, click on the
...
[Mailjet Account Information ](https://app.mailjet.com/account) page. Next, click on
:guilabel:`Add a Sender Domain or Address` link under the :guilabel:`Senders & Domains` section.
...
account/sender) page on the Mailjet account information and clicking on :guilabel:`Manage`.
...
](https://app.mailjet.com/account/setup). It is recommended to use :abbr:`SSL (Secure Sockets
