---
title: "PDF reports"
source_url: "https://docs.odoo.sbggai.top/applications/studio/pdf_reports.html"
---
...
- :guilabel:`Text`: Eight fonts are available: Lato, Roboto, Open Sans, Montserrat, Oswald,
  ...
  website ](https://fonts.google.com/) to preview them.
...
.. spoiler:: Images
   ...
   - `class`: CSS classes applied on the `img` tag; [Bootstrap classes
     ](https://getbootstrap.com/docs/5.1/content/tables) are available.
