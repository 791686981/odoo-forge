...
source_url: "https://docs.odoo.sbggai.top/applications/productivity/voip/axivox/conference_calls.html"
---
...
](https://manage.axivox.com). After logging in, click on :guilabel:`Conferences` in the menu on the
left.
