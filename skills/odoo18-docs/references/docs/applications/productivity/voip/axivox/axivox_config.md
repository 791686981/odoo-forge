---
title: "VoIP services in Odoo with Axivox"
source_url: "https://docs.odoo.sbggai.top/applications/productivity/voip/axivox/axivox_config.html"
---
...
](https://www.axivox.com/). In that case, a VoIP server is **not** necessary, as the
...
>    Access the domain on the Axivox administrative panel by navigating to [https://manage.axivox.com/
   ](https://manage.axivox.com/). After logging into the portal, go to :menuselection:`Users -->
