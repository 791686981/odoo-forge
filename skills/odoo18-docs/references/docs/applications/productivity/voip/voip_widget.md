---
title: "VoIP actions"
source_url: "https://docs.odoo.sbggai.top/applications/productivity/voip/voip_widget.html"
---
...
>    The |VOIP| number is the one provided by Axivox. It can be accessed by navigating to
   [https://manage.axivox.com/ ](https://manage.axivox.com/). After logging into the portal, go to
