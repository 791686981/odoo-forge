---
title: "Configure ICE servers with Twilio"
source_url: "https://docs.odoo.sbggai.top/applications/productivity/discuss/ice_servers.html"
---
...
First, go to [Twilio ](https://www.twilio.com) and click :guilabel:`Sign up` to create a new
