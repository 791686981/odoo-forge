---
title: "WhatsApp"
source_url: "https://docs.odoo.sbggai.top/applications/productivity/whatsapp.html"
---
...
](https://developers.facebook.com/products/whatsapp/) to communicate with their customers by text,
...
](https://business.facebook.com/overview). Begin by clicking :guilabel:`Create account` and then
...
>    If the business account is linked to a personal Facebook account then the administrator must
   ...
   ](https://developers.facebook.com) and click on the *account name* in the upper right corner.
...
>    If a payment method hasn't been added this will be necessary to proceed. [Visit Meta's
   ...
   ](https://www.facebook.com/business/help/915454841921082?id=180505742745347). This is part of
...
](https://business.facebook.com/wa/manage/home), and then go to :menuselection:`Account tools -->
Message templates`.
