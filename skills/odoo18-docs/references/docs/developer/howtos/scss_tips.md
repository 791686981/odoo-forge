---
title: "Write lean easy-to-maintain CSS"
source_url: "https://docs.odoo.sbggai.top/developer/howtos/scss_tips.html"
---
...
](https://getbootstrap.com/docs/5.1/getting-started/introduction/) (BS), one of the most complete
...
.. seealso::
   ...
   ](https://github.com/twbs/bootstrap/blob/1a6fdfae6b/scss/_reboot.scss)
...
](https://getbootstrap.com/docs/5.1/utilities/background/) stack and defines its own using
...
.. seealso::
   ...
   - [Odoo custom utilities on github
     ]({GITHUB_PATH}/addons/web/static/src/scss/utilities_custom.scss)
