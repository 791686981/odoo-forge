---
title: "Whether the view should be populated with a set of sample records if none are found for the"
source_url: "https://docs.odoo.sbggai.top/developer/reference/user_interface/view_architectures/root_attribute_sample.html"
---
