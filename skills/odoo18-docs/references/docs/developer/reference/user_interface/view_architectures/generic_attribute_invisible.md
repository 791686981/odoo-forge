---
title: "Whether the element is visible (`False`) or hidden (`True`), as a Python expression that"
source_url: "https://docs.odoo.sbggai.top/developer/reference/user_interface/view_architectures/generic_attribute_invisible.html"
---
