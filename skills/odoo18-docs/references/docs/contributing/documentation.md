---
title: ""
source_url: "https://docs.odoo.sbggai.top/contributing/documentation.html"
---
...
](https://en.wikipedia.org/wiki/Lightweight_markup_language) consisting of regular text augmented
...
#. First, [create a GitHub account ](https://github.com/join). Odoo uses GitHub to manage the
...
#. Go to [github.com/odoo/documentation ](https://github.com/odoo/documentation) and click on the
...
#. Install the latest release of [Python ](https://wiki.python.org/moin/BeginnersGuide/Download)
...
#. Install the Python dependencies of the documentation with pip.
   ...
   .. tabs::
      ...
      .. group-tab:: Linux and macOS
         ...
         ](https://unix.stackexchange.com/a/26059) with the installation path of the Python
...
>          Some steps of this guide require to be comfortable with Git. Here are some [tutorials
         ](https://www.atlassian.com/git/tutorials) and an [interactive training
         ](https://learngitbranching.js.org/) if you are stuck at some point.
      ...
      #. Write a [redirect rule
         ](https://github.com/odoo/documentation/tree/{BRANCH}/redirects/MANUAL.md) for every RST
