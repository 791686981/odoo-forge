---
title: ""
source_url: "https://docs.odoo.sbggai.top/developer/reference/frontend/hooks.html"
---
...
.. list-table::
   ...
   * - `popper`
     - string
     - this is a [useRef reference ](https://github.com/odoo/owl/blob/master/doc/reference/hooks.md#useref) for the element that will get positioned.
       Default is `"popper"`.
   * - `container`
     - HTMLElement
...
.. list-table::
   ...
   * - `refName`
     - string
     - this is a [useRef reference ]({OWL_PATH}/doc/reference/hooks.md#useref) for the element that will be
       spellcheck enabled.
