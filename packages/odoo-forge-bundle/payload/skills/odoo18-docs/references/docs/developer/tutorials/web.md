---
title: ""
source_url: "https://docs.odoo.sbggai.top/developer/tutorials/web.html"
---
...
](http://en.wikipedia.org/wiki/Genshi_(templating_language)), [Thymeleaf
](http://en.wikipedia.org/wiki/Thymeleaf) or [Facelets
](http://en.wikipedia.org/wiki/Facelets). It has the following
characteristics:
...
>     To inject user-provided values in translatable strings, it is recommended
    ...
    ](http://gabceb.github.io/underscore.string.site/#sprintf) with named
