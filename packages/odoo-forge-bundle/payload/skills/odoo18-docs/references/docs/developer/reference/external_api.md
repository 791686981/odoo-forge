---
title: "External API"
source_url: "https://docs.odoo.sbggai.top/developer/reference/external_api.html"
---
...
>          These examples use the [Ripcord ](https://code.google.com/p/ripcord/)
         ...
         ](https://php.net/manual/en/xmlrpc.installation.php) in your PHP
         installation.

         Since calls are performed over
         [HTTPS ](https://en.wikipedia.org/wiki/HTTP_Secure), it also requires that
         the [OpenSSL extension
         ](https://php.net/manual/en/openssl.installation.php) be enabled.
