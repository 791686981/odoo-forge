---
title: "Safeguard your code with unit tests"
source_url: "https://docs.odoo.sbggai.top/developer/tutorials/unit_tests.html"
---
...
**Reference**:
[Odoo's Test Framework: Learn Best Practices ](https://www.youtube.com/watch?v=JEIscps0OOQ)_
...
[Runbot FAQ ](https://runbot.odoo.com/doc)_.

Most of the tests are run on [Runbot ](https://runbot.odoo.com)_ every time a commit is pushed on
GitHub.
...
[Mergebot ](https://mergebot.odoo.com)_ is the last testing phase before merging a PR.
...
.. note:: For better readability, split your tests into multiple files depending on the scope of the
  ...
  [account ]({GITHUB_PATH}/addons/account/tests/common.py)_.
