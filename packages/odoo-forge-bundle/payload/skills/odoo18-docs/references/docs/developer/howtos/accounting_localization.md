---
title: ""
source_url: "https://docs.odoo.sbggai.top/developer/howtos/accounting_localization.html"
---
...
.. example::
  [addons/l10n_lt/data/template/account.account-lt.csv ]({GITHUB_PATH}/addons/l10n_lt/data/template/account.account-lt.csv)
...
.. example::
  [addons/l10n_ch/data/template/account.account-ch.csv ]({GITHUB_PATH}/addons/l10n_ch/data/template/account.account-ch.csv)
...
.. example::
  [addons/l10n_ae/data/template/account.tax-ae.csv ]({GITHUB_PATH}/addons/l10n_ae/data/template/account.tax-ae.csv)
...
.. example::
  [addons/l10n_au/data/account_tax_report_data.xml ]({GITHUB_PATH}/addons/l10n_au/data/account_tax_report_data.xml)
...
.. example::
  [addons/l10n_ch/demo/demo_company.xml ]({GITHUB_PATH}/addons/l10n_ch/demo/demo_company.xml)
...
.. example::
   ...
   * [ir.actions.client and menu item creation ]({GITHUB_ENT_PATH}/l10n_be_reports/data/partner_vat_listing.xml)
