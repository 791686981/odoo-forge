---
title: "The `HTML class <https://en.wikipedia.org/wiki/HTML_attribute>`_ to set on the generated element."
source_url: "https://docs.odoo.sbggai.top/developer/reference/user_interface/view_architectures/generic_attribute_class.html"
---
...
.. attribute:: class
   ...
   The styling uses the [Bootstrap ](https://getbootstrap.com) framework and :ref:`UI icons
