---
title: "View records"
source_url: "https://docs.odoo.sbggai.top/developer/reference/user_interface/view_records.html"
---
...
- An `xpath` element with an `expr` attribute. `expr` is an [XPath
  ](https://en.wikipedia.org/wiki/XPath) expression\ [#hasclass]_ applied to the current `arch`,
