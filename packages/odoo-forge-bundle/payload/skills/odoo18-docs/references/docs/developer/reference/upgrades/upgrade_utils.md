---
title: "Upgrade utils"
source_url: "https://docs.odoo.sbggai.top/developer/reference/upgrades/upgrade_utils.html"
---
...
On [Odoo.sh ](https://www.odoo.sh/) it is recommended to add it to the :file:`requirements.txt` of
...
](https://github.com/odoo/upgrade-util/tree/master/src/util) for the comprehensive declaration of
helper functions.
