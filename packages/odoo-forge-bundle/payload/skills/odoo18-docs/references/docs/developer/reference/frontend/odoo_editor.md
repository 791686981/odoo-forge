---
title: "Odoo Editor"
source_url: "https://docs.odoo.sbggai.top/developer/reference/frontend/odoo_editor.html"
---
...
.. example::
    ...
    ]({GITHUB_PATH}/addons/mass_mailing/static/src/js/wysiwyg.js)
    `web_editor`'s [Wysiwyg class
    ]({GITHUB_PATH}/addons/web_editor/static/src/js/wysiwyg/wysiwyg.js), which
...
.. example::
    ...
    ]({GITHUB_PATH}/addons/web_editor/static/src/js/wysiwyg/wysiwyg.js), you
