---
title: "Layout"
source_url: "https://docs.odoo.sbggai.top/developer/howtos/website_themes/layout.html"
---
...
.. note:: Fields creation is also possible (and recommended) through [a model using Python ](/developer/tutorials/backend).
