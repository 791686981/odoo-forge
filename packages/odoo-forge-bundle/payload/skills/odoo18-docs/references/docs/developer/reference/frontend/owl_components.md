---
title: ""
source_url: "https://docs.odoo.sbggai.top/developer/reference/frontend/owl_components.html"
---
...
The `Object`'s used for the left/right swipe must contain:
    ...
    - `bgColor` is the background color, given to decorate the action.
      ...
      ](https://getbootstrap.com/docs/3.3/components/#available-variations) (`danger`,
...
.. list-table::
    ...
    * - `class`
      - `String` or `Object`
      - Optional value added to the root span classname (supports both strings and [OWL classname object notation ](https://github.com/odoo/owl/blob/master/doc/reference/templates.md#dynamic-class-attribute)).
    * - `onSelected`
      - `Function`
