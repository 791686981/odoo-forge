---
title: ""
source_url: "https://docs.odoo.sbggai.top/contributing/development.html"
---
...
#. First, you need to [create a GitHub account ](https://github.com/join). Odoo uses GitHub to
...
#. Go to [github.com/odoo/odoo ](https://github.com/odoo/odoo) and click on the :guilabel:`Fork`
...
#. [Sign the Odoo CLA ]({GITHUB_PATH}/doc/cla/sign-cla.md) if not already done. Skip this step if
   you work at Odoo.
#. Make the desired changes to the codebase. When working on the codebase, follow these rules:
   ...
   - Respect the [stable policy
     ](https://github.com/odoo/odoo/wiki/Contributing#what-does-stable-mean) when working in
...
#. Open a :abbr:`PR (Pull Request)` on GitHub to submit your changes for review.
   ...
   #. Go to the [compare page of the odoo/odoo codebase ](https://github.com/odoo/odoo/compare), or
      the [compare page of the odoo/enterprise codebase
      ](https://github.com/odoo/enterprise/compare), depending on which codebase your changes
      target.
