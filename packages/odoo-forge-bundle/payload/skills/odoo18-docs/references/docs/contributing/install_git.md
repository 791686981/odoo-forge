---
title: "`Install Git <https://git-scm.com/book/en/v2/Getting-Started-Installing-Git>`_. It is a command-line"
source_url: "https://docs.odoo.sbggai.top/contributing/install_git.html"
---
...
.. tabs::
   ...
   .. group-tab:: Linux and macOS
      ...
      ](https://unix.stackexchange.com/a/26059) with the installation path of Git (by default
      :file:`/usr/bin/git`).
