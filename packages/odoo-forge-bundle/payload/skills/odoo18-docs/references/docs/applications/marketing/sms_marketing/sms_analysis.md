---
title: "SMS analysis"
source_url: "https://docs.odoo.sbggai.top/applications/marketing/sms_marketing/sms_analysis.html"
---
...
>    SMS messages can be sent using automation rules in Odoo. Odoo *Studio* is required to use
   ...
   cost. Consult [support ](https://www.odoo.com/contactus), or reach out to the database's
