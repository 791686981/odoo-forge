---
title: ""
source_url: "https://docs.odoo.sbggai.top/applications/finance/accounting/taxes/avatax/avalara_portal.html"
---
...
](https://sandbox.admin.avalara.com/) or [production ](https://admin.avalara.com/) environment.
...
either Avalara's [sandbox ](https://sandbox.admin.avalara.com/) or [production
](https://admin.avalara.com/) environment. This will depend on which type of account was set in the
...
](https://admin.avalara.com/). Then, from the main dashboard, click :guilabel:`Returns`. Avalara
