---
title: "PayPal"
source_url: "https://docs.odoo.sbggai.top/applications/finance/payment_providers/paypal.html"
---
...
>    While PayPal is available in [over 200 countries/regions
   ](https://www.paypal.com/webapps/mpp/country-worldwide), only [a selection of currencies are
...
#. [Log into your PayPal Developer Dashboard ](https://developer.paypal.com/dashboard/).
...
>    If you use customer names or addresses that include accented or non-Latin characters, you
   **must** configure the encoding format of the payment request sent by Odoo to PayPal to avoid
   ...
   setting ](https://www.paypal.com/cgi-bin/websrc?cmd=_profile-language-encoding), click
   ...
   ](https://sandbox.paypal.com/cgi-bin/customerprofileweb?cmd=_profile-language-encoding).
...
#. Log into the [Paypal Developer Site ](https://developer.paypal.com/) using your PayPal
