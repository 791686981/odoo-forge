---
title: "Mexico"
source_url: "https://docs.odoo.sbggai.top/applications/finance/fiscal_localizations/mexico.html"
---
...
tramitesyservicios/Paginas/documentos/Anexo_20_Guia_de_llenado_CFDI.pdf), a legal requirement, as
...
#. Choose a PAC (Proveedor Autorizado de Certificación / Authorized Certification Provider).
   ...
   ](https://solucionfactible.com/), [Quadrum (formerly Finkok) ](https://cfdiquadrum.com.mx/) and
...
certifica) with the |SAT|, you **must** register directly with the :ref:`PAC <mx-requirements>` of
...
](https://www.gob.mx/tramites/ficha/certificado-de-sello-digital/SAT139) must be uploaded within
...
](http://omawww.sat.gob.mx/tramitesyservicios/Paginas/anexo_20.htm) version 4.0 of electronic
...
>    The exact configurations are in the [Anexo 20 of the SAT
   ](http://omawww.sat.gob.mx/tramitesyservicios/Paginas/anexo_20.htm). Usually, the
...
](https://www.sat.gob.mx/consultas/91447/nuevo-esquema-de-cancelacion), since January 1st, 2022,
...
](http://omawww.sat.gob.mx/tramitesyservicios/Paginas/complemento_comercio_exterior.htm), such as:
...
fields must coincide with the [Official SAT Catalog ](sat-catalog_), or you will receive an error.
...
#. The [correct  ](https://www.ventanillaunica.gob.mx/vucem/Clasificador.html) :guilabel:`Tariff
...
](http://omawww.sat.gob.mx/tramitesyservicios/Paginas/complemento_carta_porte.htm) as *dangerous
...
](https://www.sat.gob.mx/aplicacion/42150/envia-tu-contabilidad-electronica) refers to the
...
terceros-(diot)-): A report of vendor's journal entries that involve IVA taxes that can be
