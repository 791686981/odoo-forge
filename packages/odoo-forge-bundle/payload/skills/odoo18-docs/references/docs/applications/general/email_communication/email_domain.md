---
title: "Configure DNS records to send emails in Odoo"
source_url: "https://docs.odoo.sbggai.top/applications/general/email_communication/email_domain.html"
---
...
](https://mxtoolbox.com/spf.aspx). The process to create or modify an SPF record depends on the
...
](https://mxtoolbox.com/dkim.aspx). Enter `example.com:odoo` in the DKIM lookup tool, specifying
