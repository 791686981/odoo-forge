---
title: "Use VoIP services in Odoo with OnSIP"
source_url: "https://docs.odoo.sbggai.top/applications/productivity/voip/onsip.html"
---
...
](https://info.onsip.com/odoo/). OnSIP is a VoIP provider. An account is needed with OnSIP in order
to use this service.
...
> **tip**:
>    To access the OnSIP domain, navigate to [OnSIP ](https://www.onsip.com/) and log in. Then, click
...
.. seealso::
   ...
   ](https://support.onsip.com/hc/en-us).
