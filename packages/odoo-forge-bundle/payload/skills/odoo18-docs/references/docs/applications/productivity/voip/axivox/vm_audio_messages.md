---
title: "Voicemails and audio messages"
source_url: "https://docs.odoo.sbggai.top/applications/productivity/voip/axivox/vm_audio_messages.html"
---
...
Axivox admin portal settings. To do that, navigate to [manage.axivox.com ](axivox_admin_). After
...
[manage.axivox.com ](axivox_admin_). Then, log in with the appropriate administrator credentials.
...
access the portal, visit [manage.axivox.com ](axivox_admin_) and log in. Then, navigate to
...
settings, go to [manage.axivox.com ](axivox_admin_) and log in.
...
To record an audio message in Axivox, navigate to [manage.axivox.com ](axivox_admin_) and log in.
...
[manage.axivox.com ](axivox_admin_), and log in.
