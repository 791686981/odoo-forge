---
title: "Webhooks"
source_url: "https://docs.odoo.sbggai.top/applications/studio/automated_actions/webhooks.html"
---
...
>   - Setting up a webhook in Odoo requires no coding when connecting Odoo databases, but testing
    requires an external tool like [Postman ](https://www.postman.com/). :ref:`Custom target
...
>    Testing the webhook requires the webhook to be set up, a test payload to send to the webhook, and
   ...
   tool like [Postman ](https://www.postman.com/) so less technical skills are required.
...
[Postman ](https://www.postman.com/) to send the simulated trigger.
