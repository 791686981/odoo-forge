---
title: "VAT numbers verification (VIES)"
source_url: "https://docs.odoo.sbggai.top/applications/finance/accounting/taxes/vat_verification.html"
---
...
>    Regardless of whether or not the Verify VAT Numbers feature is enabled, Odoo checks the format of
   ...
   ](https://en.wikipedia.org/wiki/VAT_identification_number) from that country.
