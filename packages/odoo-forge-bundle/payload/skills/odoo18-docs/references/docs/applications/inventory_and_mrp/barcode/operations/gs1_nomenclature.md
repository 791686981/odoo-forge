---
title: "GS1 barcode nomenclature"
source_url: "https://docs.odoo.sbggai.top/applications/inventory_and_mrp/barcode/operations/gs1_nomenclature.html"
---
...
](https://www.gs1.org/standards/get-barcodes) (GTIN), purchased by businesses, to enable global
...
>    |GTINs| are unique product identification that **must** be [purchased from GS1
   ](https://www.gs1.org/standards/get-barcodes) to use GS1 barcodes.
...
](https://www.gs1.org/standards/get-barcodes) as an internationally distinct product identifier
...
](https://www.gs1.org/standards/barcodes/application-identifiers) (A.I.). This required prefix
...
](https://www.gs1.org/services/check-digit-calculator) as the final character.
