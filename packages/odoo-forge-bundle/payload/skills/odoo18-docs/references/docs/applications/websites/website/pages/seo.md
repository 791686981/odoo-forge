...
source_url: "https://docs.odoo.sbggai.top/applications/websites/website/pages/seo.html"
---
...
>    - Odoo provides several modules to help you build your website content, such as
   ...
   - All Odoo :doc:`themes <../web_design/themes>` rely on the CSS Framework [Bootstrap
     ](https://getbootstrap.com/) to render efficiently according to the device: desktop, tablet,
