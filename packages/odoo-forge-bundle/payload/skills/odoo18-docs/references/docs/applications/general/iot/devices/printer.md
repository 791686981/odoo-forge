...
source_url: "https://docs.odoo.sbggai.top/applications/general/iot/devices/printer.html"
---
...
](https://download4.epson.biz/sec_pubs/pos/reference_en/escpos/gs_lv_0.html) and [ESC *
](https://download4.epson.biz/sec_pubs/pos/reference_en/escpos/esc_asterisk.html) commands.
...
.. spoiler::
   ...
   #. For the naming convention, since the printer must print using the `ESC *` command, it is
      ...
      ](https://download4.epson.biz/sec_pubs/pos/reference_en/escpos/esc_asterisk.html), the `m`
