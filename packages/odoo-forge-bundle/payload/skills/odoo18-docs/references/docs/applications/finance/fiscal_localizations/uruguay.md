---
title: "Uruguay"
source_url: "https://docs.odoo.sbggai.top/applications/finance/fiscal_localizations/uruguay.html"
---
...
- :guilabel:`DGI Main Branch Code`: this is part of the XML when creating an electronic document. If
  ...
  #. From your [DGI account ](https://servicios.dgi.gub.uy/serviciosenlinea), go to
...
](https://odootest.ucfe.com.uy/Gestion/) or [production ](https://prod6109.ucfe.com.uy/Gestion/))
portal.
...
.. seealso::
   - [Odoo Tutorials: Uruguay Localization
     ](https://www.odoo.com/slides/smart-tutorial-localizacion-de-uruguay-432)
