---
title: "Call queues"
source_url: "https://docs.odoo.sbggai.top/applications/productivity/voip/axivox/call_queues.html"
---
...
](https://manage.axivox.com). In the left menu, click :guilabel:`Queues`. Next, click
...
](https://manage.axivox.com), and click :guilabel:`Queues`, located in the left-hand column.
...
](https://manage.axivox.com), and click :guilabel:`Queues`, located in the left-hand column. Then,
