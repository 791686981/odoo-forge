---
title: "Advanced dial plans"
source_url: "https://docs.odoo.sbggai.top/applications/productivity/voip/axivox/dial_plan_advanced.html"
---
...
](https://manage.axivox.com). Then, go to the :guilabel:`Recording` drop-down menu, near the bottom
...
To add one of these elements, navigate to the :guilabel:`Dial plans` page, located in the menu on
the left side of the [Axivox management console ](https://manage.axivox.com). Next, click on the
...
>    To set the :guilabel:`Timezone` that the :guilabel:`Time Condition` operates under, navigate to
   [Axivox management console ](https://manage.axivox.com), and click :guilabel:`Settings` in the
...
A :guilabel:`Switch` can be set in the [Axivox management console ](https://manage.axivox.com) by
...
](https://manage.axivox.com), and click on :guilabel:`Dial plans` in the left menu. Then, click
...
](https://manage.axivox.com). Then, click on the :guilabel:`Switches` menu item in the left menu.
...
](https://manage.axivox.com), and click :guilabel:`Dial plans` in the left menu.
