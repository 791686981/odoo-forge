---
title: "Digest emails"
source_url: "https://docs.odoo.sbggai.top/applications/general/companies/digest_emails.html"
---
...
>    Here is the [source code
   ](https://github.com/odoo/odoo/blob/15.0/addons/digest/models/digest.py) for the `digest.py`
