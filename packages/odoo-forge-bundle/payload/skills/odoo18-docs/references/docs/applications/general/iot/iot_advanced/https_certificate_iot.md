---
title: ""
source_url: "https://docs.odoo.sbggai.top/applications/general/iot/iot_advanced/https_certificate_iot.html"
---
...
- If the router does not support this, you need to update the DNS settings directly on each device
  ...
  ](https://developers.google.com/speed/public-dns). Instructions for configuring DNS on individual
