...
source_url: "https://docs.odoo.sbggai.top/applications/sales/crm/optimize/partner_autocomplete.html"
---
...
>    When getting a company's contact information make sure to be aware of the latest EU regulations.
   ...
   ](http://odoo.com/gdpr). In Odoo, individual contact information cannot be searched for with
