---
title: "Outlook Calendar synchronization"
source_url: "https://docs.odoo.sbggai.top/applications/productivity/calendar/outlook.html"
---
...
develop/quickstart-create-new-tenant) on how to set up a Microsoft *Entra ID* (formally called
...
](https://portal.azure.com/#home). Next, select :guilabel:`View` under the section labeled
...
](https://docs.microsoft.com/en-us/azure/active-directory/develop/reply-url) page.
