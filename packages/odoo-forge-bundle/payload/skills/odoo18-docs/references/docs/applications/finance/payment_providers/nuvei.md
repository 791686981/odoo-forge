---
title: "Nuvei"
source_url: "https://docs.odoo.sbggai.top/applications/finance/payment_providers/nuvei.html"
---

=====
# Nuvei

[Nuvei ](https://www.nuvei.com) is a Canadian-based payment solution provider that covers
...
#. Create a Nuvei account, if necessary, via our [referral page ](https://pages.nuvei.com/odoo-referral-0).
#. Nuvei uses two separate portals for Sandbox and Production environments. Utilize the
   [Sandbox Dashboard ](https://sandbox.nuvei.com/login) to test the integration without charging
   your customers. Once you are ready to accept payments, switch to the
   [Production Dashboard ](https://cpanel.nuvei.com/login).
