---
title: "Stripe"
source_url: "https://docs.odoo.sbggai.top/applications/finance/payment_providers/stripe.html"
---
...
>    - To use an existing Stripe account, :ref:`activate the Developer mode <developer-mode>` and
   ...
   - You can also test Stripe using the :ref:`payment_providers/test-mode`. To do so, first,
     [log into your Stripe dashboard ](https://dashboard.stripe.com/dashboard) and switch to the
...
#. Go to [the API keys page on Stripe ](https://dashboard.stripe.com/account/apikeys), or log into
...
.. tabs::
   ...
   .. tab:: Create the webhook manually
      ...
      #. Go to the [Webhooks page on Stripe ](https://dashboard.stripe.com/webhooks), or log into
